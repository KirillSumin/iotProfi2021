...
class Window:
    ...
    def __init__(self, title, layout=None, default_element_size=DEFAULT_ELEMENT_SIZE, default_button_element_size=(None, None),
                 ...
                 no_titlebar=False, grab_anywhere=False, keep_on_top=False, resizable=True, disable_close=True,margins=(None, None), element_justification='left',
                 disable_minimize=False, background_image=None, finalize=False,
                 web_debug=False, web_ip='0.0.0.0', web_port=3333, web_start_browser=False, web_update_interval=0.001, web_multiple_instance=False ):
        '''
